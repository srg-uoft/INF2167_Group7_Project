...
Initial exploratory data analysis was done in R [@cite-R] making heavy use of the Tidyverse library [@cite-tidyverse], with the goal of uncovering high-level trends and possible variables of interest for further analysis. To improve reproducibility, all filepaths were made relative using the Here package [@cite-here], and project contents were regularly revisioned to GitHub. 
