...
Understanding the key variables to answering our research question, statistical visuals, and summary tables were generated using the *ggplot2* library from [@cite-tidyverse] and [@cite-kableExtra]. Selections from these that best contribute to answering the research question, as well as discussions on the limitations and implications of the trends revealed by these visuals, can be found in the later sections of this paper.
...
Looking at Figure 2, we see that trends in collision frequency are similar across all five vehicle types. Overnight collisions (21:00 - 04:00) are low, before a sharp increase between 05:00-09:00. We then see a steady increase throughout late morning and afternoon, a daily high between 15:00 and 18:00, and then a steady decline through the evening for all vehicle types. While collisions frequency for automobiles is substantially higher than for other vehicle types (looking at the differeing y-axis scales for the various vehicle plots), the daily pattern remains the same.
...
- rush hour
- winter weather versus only biking/motorcycle in summer
- weekday more people are commuting
- confirms research that collisions do have hotspots and are not random
- trends do change by vehicle type, but the correlation is not strong enough to use as a predictor
  - maybe better if we had more data from collisions involving non-car vehicles

## Limitations
- mostly automobile data
- only data severe enough to warrant police showing up
- folks who don't want police there might not call and therefore are excluded

## Future Research Directions
- better models
- more focus on spatial data
- look at accident severity too
